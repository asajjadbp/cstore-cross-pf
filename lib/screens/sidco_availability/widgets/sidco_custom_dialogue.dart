...
class SidcoCustomDialog extends StatefulWidget {
  ...
  @override
  State<SidcoCustomDialog> createState() => _SidcoCustomDialogState();
}

class _SidcoCustomDialogState extends State<SidcoCustomDialog> {
